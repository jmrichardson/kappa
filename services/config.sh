...
docker-compose exec kafka /opt/bitnami/kafka/bin/kafka-topics.sh --create --zookeeper 192.168.1.100:2181 --topic daily_alphavantage --partitions 4 --replication-factor 2
